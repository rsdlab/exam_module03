...
exam_module03_spec = ["implementation_id", "exam_module03", 
         "type_name",         "exam_module03", 
...
# 
# </rtc-template>
class exam_module03(OpenRTM_aist.DataFlowComponentBase):
...
def exam_module03Init(manager):
    profile = OpenRTM_aist.Properties(defaults_str=exam_module03_spec)
    manager.registerFactory(profile,
                            exam_module03,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    exam_module03Init(manager)
    ...
    # Create a component
    comp = manager.createComponent("exam_module03" + args)
